...
def _status_html(d: dict[str, Any]) -> str:
    ...
    rows = "".join(
        ...
        for j in d["recent"]
    ) or "<tr><td colspan=6 style='color:#888'>no jobs</td></tr>"
...
<body><h2>TaskLane</h2>
<p>worker: <b style="color:{wc}">{wa}</b> &nbsp;|&nbsp; {counts} &nbsp;|&nbsp; <span style=color:#888>auto-refresh 15s</span></p>
<table><tr><th>job</th><th>state</th><th>try</th><th>title</th><th>last error</th><th>updated (UTC)</th></tr>{rows}</table>
</body></html>"""
